...
class TestDoWhileBlockSyntax(BaseTestClass):
...
while (isFoo)'''
    ...
    def test_does_not_raise_error_with_one_empty_line_before_and_after_do_while_block(self):
        code_string = '''\
- (void)fooMethod
{
    line;
    ...
    def test_does_not_raise_error_with_correct_indents_in_do_while_block(self):
        code_string = '''\
- (void)fooMethod
{
    do
...
while(isFoo)'''
        ...
        # verify
        self.will_raise_error_with_code(code_string, [4], [5], ["Wrong whitespace count"])
...
while  (isFoo)'''
        ...
        # verify
        self.will_raise_error_with_code(code_string, [4], [7], ["Wrong whitespace count"])
...
while (   isFoo)'''
        ...
        # verify
        self.will_raise_error_with_code(code_string, [4], [10], ["Wrong whitespace count"])
...
while (isFoo    )'''
        ...
        # verify
        self.will_raise_error_with_code(code_string, [4], [16], ["Wrong whitespace count"])
...
while (isFoo)'''
    ...
    def test_raises_error_empty_line_should_not_be_before_while_expression_of_block(self):
        code_string = '''\
do
{
}
...
while (isFoo)'''
    ...
    def test_raises_error_one_empty_line_should_be_before_do_while_block(self):
        code_string = '''\
- (void)fooMethod
{
    line;
...
- (void)fooMethod
{
    ...
    def test_raises_error_do_word_should_have_four_whitespace_symbols_indent(self):
        code_string = '''\
- (void)fooMethod
{
   do
...
- (void)fooMethod
{
    ...
    def test_raises_error_open_brace_of_do_while_block_should_have_four_whitespace_symbols_indent(self):
        code_string = '''\
- (void)fooMethod
{
    do
...
- (void)fooMethod
{
    ...
    def test_raises_error_close_brace_of_do_while_block_should_have_four_whitespace_symbols_indent(self):
        code_string = '''\
- (void)fooMethod
{
    do
...
- (void)fooMethod
{
    ...
    def test_raises_error_code_inside_do_while_block_should_have_four_whitespace_symbols_indent(self):
        code_string = '''\
- (void)fooMethod
{
    do
