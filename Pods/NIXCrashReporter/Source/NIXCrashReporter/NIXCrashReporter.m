...
+ (void)sendReportViaRequest
{
    ...
    if (reportData != nil)
    {
        ...
        NSURL *url = [NSURL URLWithString:@"https://mds.nixsolutions.com/"];
        AFHTTPClient *httpClient = [[AFHTTPClient alloc] initWithBaseURL:url];
        
        [httpClient registerHTTPOperationClass:[AFXMLRequestOperation class]];
        [httpClient setDefaultHeader:@"Content-Type" value:@"text/html"];
        
        [httpClient postPath:@"/api/upload-crash-report"
